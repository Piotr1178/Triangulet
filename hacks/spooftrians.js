        ...
        if (window.location.pathname.split('/')[1] == 'trians') {
            ...
            capsules['ValuesnCapsules'].forEach(capsule => {
                ...
                capsule.trians.forEach(trian => {
                    triansAdded.push(`<div class="styles__blookContainer___3JrKb-camelCase" role="button" tabindex="0"><div class="styles__blookContainer___36LK2-camelCase styles__blook___bNr_t-camelCase" id="${trian.name}"><img draggable="false" src="/media/capsules/${capsule.name}/trians/${trian.name}.png" class="styles__blook___1R6So-camelCase"></div><div class="styles__blookText___3AMdK-camelCase" id="triannumcircle${trian.name}" style="background-color: ${color[trian['rarity']]}">1</div></div>`)
                })
